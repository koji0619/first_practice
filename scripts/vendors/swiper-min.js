...
!(function (e, t) {
  ...
  var n = {
    ...
    o = {
      ...
      pointerEvents:
        !!t.PointerEvent && "maxTouchPoints" in t.navigator && t.navigator.maxTouchPoints > 0,
  ...
  var h = {
    ...
    updateSlides: function () {
      ...
      if (void 0 !== s) {
        ...
        for (
          var C, M = e.slidesPerColumn, P = E / M, z = Math.floor(h / e.slidesPerColumn), k = 0;
          k < h;
          k += 1
        ) {
          S = 0;
            ...
            if ("row" === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
              var O = Math.floor(k / (e.slidesPerGroup * e.slidesPerColumn)),
                ...
                G =
                  0 === O
                    ? e.slidesPerGroup
                    : Math.min(Math.ceil((h - O * M * e.slidesPerGroup) / M), e.slidesPerGroup);
            ...
            d[k] && (d[k].swiperSlideSize = S),
              ...
              e.centeredSlides
                ? ((y = y + S / 2 + x / 2 + w),
                  ...
                  c.push(y))
                : (e.roundLengths && (y = Math.floor(y)),
                  (T - Math.min(this.params.slidesPerGroupSkip, T)) % this.params.slidesPerGroup ==
                    0 && p.push(y),
                  c.push(y),
                  (y = y + S + w)),
    ...
    updateSlidesProgress: function (e) {
      ...
      if (0 !== i.length) {
        ...
        for (var n = 0; n < i.length; n += 1) {
          var o = i[n],
            l =
              (r + (t.centeredSlides ? this.minTranslate() : 0) - o.swiperSlideOffset) /
      ...
      if (o.cssMode) {
        ...
        return (
          ...
          0 === t
            ...
            : u.scrollTo
            ? u.scrollTo((((a = {})[w ? "left" : "top"] = y), (a.behavior = "smooth"), a))
            : (u[w ? "scrollLeft" : "scrollTop"] = y),
          !0
        );
      }
    ...
    if (!this.animating || !r.preventInteractionOnTransition) {
      ...
      if (
        ...
        (a.isTouchEvent || !("which" in l) || 3 !== l.which) &&
          !((!a.isTouchEvent && "button" in l && l.button > 0) || (a.isTouched && a.isMoved)))
      )
        if (
          r.noSwiping &&
                  ...
                  ? ((m = !1),
                    a.resistance &&
                      (i.currentTranslate =
                        this.minTranslate() -
                        1 +
                        Math.pow(-this.minTranslate() + i.startTranslate + f, g)))
                  : f < 0 &&
                    ...
                    a.resistance &&
                      (i.currentTranslate =
                        this.maxTranslate() +
                        1 -
                        Math.pow(this.maxTranslate() - i.startTranslate - f, g))),
      ...
      if (s.freeMode) {
        ...
        if (s.freeModeMomentum) {
          ...
          if (y < t.maxTranslate())
            ...
            y = -(y =
              Math.abs(d[C] - y) < Math.abs(d[C - 1] - y) || "next" === t.swipeDirection
                ? d[C]
                : d[C - 1]);
          }
          if (
  ...
  var V = {
    ...
    Q = {
      update: function (e) {
        ...
        if (
          ...
          return (
            t.slidesGrid !== v && E !== m && t.slides.css(g, E + "px"), void t.updateProgress()
          );
        ...
        if (e) t.$wrapperEl.find("." + t.params.slideClass).remove();
          ...
          for (var P = p; P <= c; P += 1)
            (P < x || P > T) &&
              t.$wrapperEl
                .find("." + t.params.slideClass + '[data-swiper-slide-index="' + P + '"]')
                .remove();
    ...
    ee = {
      handle: function (i) {
        ...
        if (
          !this.allowSlideNext &&
          ((this.isHorizontal() && 39 === r) || (this.isVertical() && 40 === r) || 34 === r)
        )
          return !1;
        if (
          !this.allowSlidePrev &&
          ((this.isHorizontal() && 37 === r) || (this.isVertical() && 38 === r) || 33 === r)
        )
          return !1;
        if (
          !(
  ...
  var ie = {
      ...
      handle: function (e) {
        ...
        if ((a.invert && (o = -o), i.params.freeMode)) {
          ...
          if (
            (x.push(y),
            T
              ? (y.direction !== T.direction || y.delta > T.delta) && i.mousewheel.animateSlider(y)
      ...
      in: function (e) {
        ...
        (w.$slideEl ||
          (this.params.virtual && this.params.virtual.enabled && this.virtual
            ? (w.$slideEl = this.$wrapperEl.children("." + this.params.slideActiveClass))
          ...
          o.gestures
            ...
            : "touchstart" === this.touchEvents.start &&
              ...
              this.touchEvents.cancel &&
                this.$wrapperEl.on(this.touchEvents.cancel, s, e.onGestureEnd, t)),
            this.$wrapperEl.on(
        ...
        if (e.enabled) {
          ...
          o.gestures
            ...
            : "touchstart" === this.touchEvents.start &&
              ...
              this.touchEvents.cancel &&
                this.$wrapperEl.off(this.touchEvents.cancel, s, e.onGestureEnd, t)),
            this.$wrapperEl.off(
              this.touchEvents.move,
              "." + this.params.zoom.containerClass,
              e.onTouchMove,
      ...
      init: function () {
        if (this.params.history) {
          if (!t.history || !t.history.pushState)
            return (
              (this.params.history.enabled = !1), void (this.params.hashNavigation.enabled = !0)
            );
          var e = this.history;
          (e.initialized = !0),
      ...
      setTranslate: function () {
        ...
        for (var u = 0; u < a.length; u += 1) {
          ...
          if (
            ...
            0 === E.length &&
              ((E = s('<div class="swiper-slide-shadow-' + (h ? "left" : "top") + '"></div>')),
              v.append(E)),
              0 === S.length &&
                ((S = s(
      ...
      setTranslate: function () {
        for (
          ...
          if ((f.transform(S), (f[0].style.zIndex = 1 - Math.abs(Math.round(g))), n.slideShadows)) {
            ...
            0 === C.length &&
              ((C = s('<div class="swiper-slide-shadow-' + (l ? "left" : "top") + '"></div>')),
              f.append(C)),
              0 === M.length &&
                ((M = s(
    ...
    be = {
      ...
      update: function (e) {
        ...
        if (t) {
          var i =
              "auto" === t.params.slidesPerView ? t.slidesPerViewDynamic() : t.params.slidesPerView,
            ...
            if (t.params.loop) {
              ...
              var l = t.slides
                ...
                d = t.slides
                  ...
                  .index();
              (r =
                void 0 === l ? d : void 0 === d ? l : d - o == o - l ? o : d - o < o - l ? d : l),
            ...
            a && (r += "next" === n ? s : -1 * s),
              t.visibleSlidesIndexes &&
                ...
                (t.params.centeredSlides
                  ? (r = r > o ? r - Math.floor(i / 2) + 1 : r + Math.floor(i / 2) - 1)
                  : r > o && (r = r - i + 1),
          ...
          if (
            ...
            for (var c = 0; c < h; c += 1)
              t.$wrapperEl
                .children('[data-swiper-slide-index="' + (this.realIndex + c) + '"]')
                .addClass(p);
